        ...
        type: {
            ...
            candidate: {
                type: {
                    ...
                    cv_cate_check: {
                        // Check xem ngành nghề của UV đã trùng với CV tải lên hay chưa
                        type: Number,
                        default: 0,
                    },
                    cv_check_sync_profile: {
                        // Check tên ứng viên đã đồng bộ với cv tải lên hay chưa
                        type: Number,
                        default: 0,
                    },
                    cv_capbac_id: {
...
// let Users_TV365 = mongoose.model('Users_TV365', UserSchema);

// module.exports = Users_TV365;

export default mongoose.model('Users_TV365', UserSchema);