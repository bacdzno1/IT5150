...
$(document).ready(function () {
  ...
  $.ajax({
    url: 'http://localhost:3050/api/topcv1s/CV/in4CV',
    type: 'POST',
    data: { idcv: idcv },
    success: function (data) {
      ...
      $.ajax({
        url: isMobile ? `http://localhost:3050/api/topcv1s/CV/upload/cv/cv_mobile/index.html` : `http://localhost:3050/api/topcv1s/CV/upload/cv/${alias}/index.html`,
        method: 'GET',
        success: function (data) {
          ...
          // Load the CSS file
          $('#cv-css').attr('href', isMobile ? "http://localhost:3050/api/topcv1s/CV/upload/cv/cv_mobile/css/cv.css" : `http://localhost:3050/api/topcv1s/CV/upload/cv/${alias}/css/cv.css`);
...
$(document).ready(function () {
  $.ajax({
    url: 'http://localhost:3050/api/topcv1s/CV/ListSampleCV',
    method: 'POST',
